...
public class guiInterface {
    ...
    public guiInterface() {
        ...
        displayArea.addKeyListener(new KeyAdapter() {
            @Override
            public void keyPressed(KeyEvent e) {  // keypressed event
                numbers[0] = a0;
                numbers[1] = a1;
                numbers[2] = a2;
                numbers[3] = a3;
                ...
                if (flag == 0) {
                    if (key == KeyEvent.VK_ENTER) {  // if enter was pressed

                        if (Main.highlight == 0) {  // if number highlighting is working, sample the number which is currently highlighted
                            ...
                            Main.highlight = 1;   // notify function gihlighting thread
                            synchronized (Main.FunctionPadLock) {
                                Main.FunctionPadLock.notify();
                            }
                        } else {   // if function highlighting is working, sample the function which is currently highlighted



                            int flag2 = 0;  // to check whether calculate was highlighted
                            for (int i = 0; i < 4; i++) {   // if(-, +, *, /) was highlighted
                            ...
                            int clred = functions[4].getBackground().getRed();   // if clear button was highlighted
                            ...
                            int calred = functions[5].getBackground().getRed();  // if calculate button was highlighted
                            ...
                            if (calred == 255 && calgreen == 212 && calblue == 255) {
                                ...
                                if (input.length() == 0) {
                                    ...
                                    String ans = evaluate.eval(input);
                            ...
                            if (flag2 == 0) {   // for non calculate button highlighted, notify function thread
                                Main.highlight = 0;
                ...
                if (flag == 1) {
                    if (key == KeyEvent.VK_ENTER) {  // if calculate button taken as input, only button that can be used is CLEAR
        ...
        calculateButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                // now  we will add the javascript engine to parse sruff
