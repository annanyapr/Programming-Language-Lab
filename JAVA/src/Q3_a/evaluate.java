...
// This class provides function that helps in evaluating the expressions coming from the calculator input and returns their output by evaluating using Javascript Engine
